...
@section('title', 'แก้ไขคอนเทนต์ · Exclusive')
@section('page-title', 'แก้ไขคอนเทนต์')

@section('content')
    <form method="POST" action="{{ route('admin.contents.update', $content) }}" class="space-y-4 max-w-4xl"
